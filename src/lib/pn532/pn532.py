...
class PN532:
    ...
    def __init__(self, *, debug=False, irq=None, reset=None):
        ...
        print("PN532 initialized. Version: ", self.firmware_version)
    ...
    def send_command(
        ...
        if not _ACK == self._read_data(len(_ACK)):
            # print("Did not receive expected ACK from PN532!")
    ...
    def get_passive_target(self, timeout=1000):
        ...
        # Return UID of card.
        #print("UID: ", response[6 : 6 + response[5]])
